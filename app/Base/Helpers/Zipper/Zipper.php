...
namespace App\Base\Helpers\Zipper;
...
class Zipper
{
    ...
    private function getArchiveFiles()
    {
        ...
        for ($i = 0; $i < $this->zipArchive->numFiles; $i++) {
            ...
            if ('.' == $name[0] and '_' == @$name[1] and in_array($this->skipMode, ['ZANYSOFT', 'ALL'])) {
                continue;
            }
    ...
    private function addItem(string $file, bool $flatroot = false, string $base = null): void
    {
        ...
        if (!is_null($base)) {
            ...
            if ('.' == $real_name[0] and '_' == @$real_name[1] and in_array($this->skipMode, ['ZANYSOFT', 'ALL'])) {
                return;
            }
        }
